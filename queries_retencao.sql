...
-- -----------------------------------------------------
-- Procedure para inserir uma nova triagem, aceita valores 
-- nulos como entrada em todas as posições exceto código 
-- de urgência.
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Procedure para inserir um novo diagnóstico.
-- Aceita valores nulos em todas as posições exceto 
-- código de urgência, código de nivel e descrição de 
-- nível.
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Procedure para inserir um novo nivel de diagnóstico 
-- e a sua descrição. Valores nulos não tolerados
-- -----------------------------------------------------
DELIMITER 
...
-- -----------------------------------------------------
-- Procedure para inserir novas entradas na tabela N:N
...
-- -----------------------------------------------------
-- Insere pacientes , 1 Urgência = 1 Paciente
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Insere um novo episódio de urgência
-- -----------------------------------------------------
